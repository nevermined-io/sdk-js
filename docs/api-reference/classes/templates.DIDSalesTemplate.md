[@nevermined-io/sdk](../code-reference.md) / [templates](../modules/templates.md) / DIDSalesTemplate
...
▸ **createService**(`publisher`, `metadata`, `assetPrice?`, `erc20TokenAddress?`, `priced?`): `Promise`<`any`\>
