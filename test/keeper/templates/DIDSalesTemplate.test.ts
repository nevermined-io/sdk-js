...
describe('DIDSalesTemplate', () => {
    ...
    //         const result = await templateStoreManager.proposeTemplate(
    //             didSalesTemplate.getAddress(),
    //             receiver.getId(),
    //             true
    //         )
    //     })
    ...
    describe('create agreement', () => {
        // it('should create agreement from ddo', async () => {
        //     const agreement = didSalesTemplate.createAgreementFromDDO
        // })
